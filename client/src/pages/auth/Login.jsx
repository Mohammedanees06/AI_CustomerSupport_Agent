    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: "var(--bg)" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold mb-1" style={{ color: "var(--text)" }}>Welcome back</h1>
          <p className="text-sm" style={{ color: "var(--text-muted)" }}>Sign in to your business dashboard</p>
        </div>
        ...
        <div className="rounded-2xl border p-7" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
          ...
          <div className="mt-5 p-3 rounded-lg border" style={{ background: "var(--bg)", borderColor: "var(--border)" }}>
            <p className="text-xs font-mono mb-1" style={{ color: "var(--text-muted)" }}>DEMO CREDENTIALS</p>
            <p className="text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
              demo@aicustomer.com<br />demo1234
            </p>
          </div>
        </div>
